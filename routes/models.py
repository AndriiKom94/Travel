...
class Route(models.Model):
    name = models.CharField(max_length=100, verbose_name='Назва маршруту', unique=True)
    from_city = models.CharField(max_length=100, verbose_name='Звідки')
    to_city = models.CharField(max_length=100, verbose_name='Куди')
    trains = models.ManyToManyField(Train, blank=True, verbose_name='Список поїздів')
